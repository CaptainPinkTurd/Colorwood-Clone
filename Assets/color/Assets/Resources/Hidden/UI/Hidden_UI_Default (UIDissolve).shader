  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: Default
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = texture(_TransitionTex, in_f.texcoord2.xy).w;
          
          u_xlat16_1.x = float(0.25);
          
          u_xlat16_1.z = float(0.75);
          
          u_xlat16_1.yw = in_f.texcoord2.zz;
          ...
          u_xlat0_d.x = (-u_xlat16_5.x) * u_xlat16_1.x + u_xlat16_0;
          
          u_xlat0_d.x = u_xlat16_5.y * 0.25 + u_xlat0_d.x;
          
          u_xlat5 = u_xlat16_5.y * 0.25 + (-u_xlat0_d.x);
          
          u_xlat0_d.y = u_xlat5 * 16.0;
          
          u_xlatb3_d.xy = greaterThanEqual(in_f.texcoord1.xyxx, _ClipRect.xyxx).xy;
          
          u_xlatb3_d.zw = greaterThanEqual(_ClipRect.zzzw, in_f.texcoord1.xxxy).zw;
          
          u_xlat3.x = u_xlatb3_d.x ? float(1.0) : 0.0;
          
          u_xlat3.y = u_xlatb3_d.y ? float(1.0) : 0.0;
          
          u_xlat3.z = u_xlatb3_d.z ? float(1.0) : 0.0;
          
          u_xlat3.w = u_xlatb3_d.w ? float(1.0) : 0.0;
      ...
      ;
          ...
          u_xlat10 = u_xlat10 * u_xlat1_d.w;
          
          u_xlatb17 = u_xlat10>=u_xlat0_d.x;
          
          u_xlat0_d.x = u_xlat0_d.x * 32.0;
          
          u_xlat0_d.xy = u_xlat0_d.xy / u_xlat16_5.zz;
          ...
          u_xlat0_d.x = u_xlatb17 ? 1.0 : float(0.0);
          
          u_xlat0_d.x = u_xlat0_d.y * u_xlat0_d.x;
          
          u_xlat16_4.xyz = u_xlat1_d.xyz * u_xlat16_2.xyz + (-u_xlat1_d.xyz);
          
          out_f.color.xyz = u_xlat0_d.xxx * u_xlat16_4.xyz + u_xlat1_d.xyz;
