...
namespace Mkey
{
    ...
    public class RotateAvatar : MonoBehaviour
    {
        ...
        //public RectTransform maskRect; this is only for roating the avatar
        float groupAngleZ;
        public bool topHalf;
        ...
        void Update()
        {
            ...
            if (activeButton && mainCanvas)
            {
                ...
                groupAngleZ = (topHalf) ? Mathf.LerpAngle(groupAngleZ, 180, Time.deltaTime * 2.0f) : Mathf.LerpAngle(groupAngleZ, 0, Time.deltaTime * acceler);
