  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          u_xlat1.xy = u_xlat1.xz * float2(u_xlat12) + (-in_v.normal.xz);
          
          u_xlat12 = -abs(in_v.tangent.w) + 1.0;
          
          u_xlat1.xy = float2(u_xlat12) * u_xlat1.xy + in_v.normal.xz;
          
          u_xlat0.xyz = u_xlat0.xyz * float3(u_xlat12) + in_v.vertex.xyz;
          
          u_xlat0.xyz = u_xlat0.xyz * _TreeInstanceScale.xyz;
          
          u_xlat12 = in_v.color.y * 0.100000001;
          
          u_xlat1.xz = u_xlat1.xy * float2(u_xlat12);
          
          u_xlat12 = dot(unity_ObjectToWorld[3].xyz, float3(1.0, 1.0, 1.0));
          ...
          u_xlat3.xyz = u_xlat3.xyz * in_v.texcoord1.yyy;
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          u_xlatb0 = 0.0<in_v.texcoord.y;
          
          out_v.texcoord.y = u_xlatb0 ? 1.0 : float(0.0);
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.texcoord1 = unity_ObjectToWorld[3] * in_v.vertex.wwww + u_xlat1;
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          u_xlat4.xyz = u_xlat2.xyz + unity_ObjectToWorld[3].xyz;
          
          out_v.texcoord1 = unity_ObjectToWorld[3] * in_v.vertex.wwww + u_xlat2;
          
          u_xlat2 = u_xlat4.yyyy * unity_MatrixVP[1];
          
          u_xlat2 = unity_MatrixVP[0] * u_xlat4.xxxx + u_xlat2;
          
          u_xlat2 = unity_MatrixVP[2] * u_xlat4.zzzz + u_xlat2;
          
          out_v.vertex = u_xlat2 + unity_MatrixVP[3];
          
          u_xlat16_3.xyz = _WavingTint.xyz + float3(-0.5, -0.5, -0.5);
          
          u_xlat16_3.xyz = u_xlat0.xxx * u_xlat16_3.xyz + float3(0.5, 0.5, 0.5);
          
          u_xlat16_3.xyz = u_xlat16_3.xyz * in_v.color.xyz;
          
          out_v.color.xyz = u_xlat16_3.xyz + u_xlat16_3.xyz;
