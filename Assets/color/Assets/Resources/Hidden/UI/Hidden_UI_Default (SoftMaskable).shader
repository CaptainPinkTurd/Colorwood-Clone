Shader "Hidden/UI/Default (SoftMaskable)"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: Default
    {
      ...
      uniform float4 _MaskInteraction;
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = _MaskInteraction + float4(-1.0, -1.0, -1.0, -1.0);
          
          u_xlat1_d.xy = hlslcc_FragCoord.xy / _ScreenParams.xy;
          
          u_xlat16_1 = texture(_SoftMaskTex, u_xlat1_d.xy);
          
          u_xlat16_2 = u_xlat16_1 * float4(-2.0, -2.0, -2.0, -2.0) + float4(1.0, 1.0, 1.0, 1.0);
          
          u_xlat16_0 = u_xlat16_0 * u_xlat16_2 + u_xlat16_1;
          
          u_xlat16_0 = u_xlat16_0 + float4(-1.0, -1.0, -1.0, -1.0);
          
          u_xlat16_0 = _MaskInteraction * u_xlat16_0 + float4(1.0, 1.0, 1.0, 1.0);
      ...
      ;
          ...
          u_xlat2.w = u_xlat16_0.x * u_xlat1_d.x;
