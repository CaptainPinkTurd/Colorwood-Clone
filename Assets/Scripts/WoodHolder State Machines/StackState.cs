...
public class StackState : IWoodHolderState
{
    ...
    {
        //DO NOT put transition from STACK to EMPTY in here, it will mess up other transitions
    ...
    public void OnClickEvent(StateManager woodHolderState)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                else if (totalPieces == 4 && holder.existedType.Count >= 2 || (totalPieces <= 4 && holder.existedType.Count >= 3))
                {
                    ...
                    DataManager.instance.pieceNeededToRemove = piecesInSelectedChunk == piecesInChunk ? 1 : Mathf.Abs(piecesInSelectedChunk - piecesInChunk);
                }
