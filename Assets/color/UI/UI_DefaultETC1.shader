  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: Default
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xyz = u_xlat16_1.xyz + _TextureSampleAdd.xyz;
          
          u_xlat16_2 = texture(_AlphaTex, in_f.texcoord.xy).x;
          
          u_xlat1_d.w = u_xlat16_2 + _TextureSampleAdd.w;
          
          u_xlat16_0.xyz = in_f.color.xyz;
          
          u_xlat16_0 = u_xlat16_0 * u_xlat1_d;
